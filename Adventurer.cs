namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            string robeDescription = $"{ColorfulRobe.Color}, {ColorfulRobe.Length}\"";
            string hatDescription = $"{WizardHat.ShininessDescription}";
            string description = $"Name: {Name} Robe: {robeDescription} Hat:{hatDescription}";
            return description;
        }
